...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { capacity: @boat.capacity, description: @boat.description, location: @boat.location, price: @boat.price, user_id_id: @boat.user_id_id } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { capacity: @boat.capacity, description: @boat.description, location: @boat.location, price: @boat.price, user_id_id: @boat.user_id_id } }
